import {SpringSet} from "./SpringSet";
            ...
            if (first_point_i !== second_point_i) {
                ...
                for (let i = 0; i < MIN_POINTS; i++) {
                    ...
                    if (current_distance > d) {
                        ...
                        best_points[i] = {point: best_point, distance: d, index: second_point_i};
                        break;
                    }
                }
            }
